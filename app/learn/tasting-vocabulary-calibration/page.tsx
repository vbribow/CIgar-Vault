...
export default function TastingVocabularyCalibrationPage() {
  return <main className="shell learnPage">
    <nav className="nav"><a className="brand" href="/">{brand.name}</a><div className="navLinks"><a href="/learn">Learn</a><a href="/records">Tasting records</a><a href="/cigar-somm">{brand.name} AI</a></div></nav>
