  ...
  return (
    <main className="shell seedToSmokePage">
      ...
      <section className="seedClosing">
        ...
        <div><p>When collectors understand the work behind tobacco, they store more carefully, ask better questions, recognize construction, value honest information, support the people behind the industry, and preserve stories that might otherwise disappear.</p><div className="ctaRow"><a className="button" href="/learn/tobacco-seed-varietals">Separate seed and varietal claims</a><a className="button secondary" href="/learn/blending">Continue to blending</a><a className="button secondary" href="/learn/resting-and-aging">Learn rest and aging</a><a className="button secondary" href="/learn/manufacturing-truth">Meet the factories</a><a className="button secondary" href="/data-model">See how {brand.name} preserves the record</a></div></div>
      </section>
    </main>
  );
}
