...
export default async function RecordsPage({
  ...
  return (
    <main className="shell">
      ...
      {inventoryId&&!selectedItem&&<section className="section card" role="alert"><strong>The requested Vault record is unavailable.</strong><p>No different cigar was selected. Return to the Vault and choose the intended record again.</p></section>}
