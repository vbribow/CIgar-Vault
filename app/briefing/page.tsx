...
export default async function BriefingPage(){
  ...
  if(!results.every(result=>result.status==="fulfilled"))return <main className="shell wideShell briefingPage">
    <section className="briefingHero"><div><div className="eyebrow">Cedriva Daily Briefing · Private</div><h1>Your briefing is temporarily paused.</h1><p className="lede">Cedriva could not verify every source needed to rank climate, collection, smoking-window, market, and industry signals. No partial briefing has been presented as complete.</p><div className="ctaRow"><a className="button" href="/briefing">Try again</a><a className="button secondary" href="/system-health">Check system health</a></div></div></section>
  </main>;
