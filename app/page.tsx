...
export default async function Home() {
  ...
  return <main className="shell">
    <section className="hero productHero"><div><div className="eyebrow">Preserve · Honor · Grow</div><h1>Your collection is a story worth preserving.</h1><p className="lede">Cedriva connects the cigars you collect with their craftsmanship, history, memories, provenance, care, and community—helping premium cigar culture endure for generations.</p><div className="ctaRow"><a className="button" href="/inventory">Open my collection</a><a className="button secondary" href="/constitution">Read our constitution</a></div></div><div className="card productPromise"><div className="eyebrow">Tradition, strengthened by technology</div><h2>Knowledge without barriers. Intelligence without pretense.</h2><p>Advanced tools respect experienced collectors while welcoming every beginner. Evidence is sourced, uncertainty is visible, and expertise is amplified—not replaced.</p><div className="trustLine"><span>Education</span><span>Trust</span><span>Community</span><span>Culture</span></div></div></section>
