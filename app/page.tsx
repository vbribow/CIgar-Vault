...
export default async function Home() {
  ...
  return <main className="shell">
    <nav className="nav"><div className="brand">Cigar Vault</div><div className="navLinks"><a href="/inventory">Inventory</a><a href="/catalog">Catalog</a><a href="/collections">Collections</a><a href="/collection-catalog">Set catalog</a><a href="/activity">Activity</a><a href="/valuations">Valuation</a><a href="/box-formats">Box formats</a><a href="/verification">Verification</a><a href="/collection-health">Collection health</a><a href="/storage">Storage</a><a href="/records">Journal</a><span className="badge">Founder MVP</span></div></nav>
