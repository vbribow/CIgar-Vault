...
const comparedFields: Array<[keyof InventoryItem, string]> = [
  ...
  ["acquisitionSourceUrl", "Acquisition source"], ["acquisitionReceiptLink", "Acquisition receipt"],
  ["purchaseJurisdiction", "Purchase jurisdiction"], ["habanosVerificationDate", "Habanos lookup date"],
  ["habanosVerificationResult", "Habanos lookup result"], ["habanosVerificationEvidenceLink", "Habanos lookup evidence"],
