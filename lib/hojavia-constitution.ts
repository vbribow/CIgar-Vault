export const hojaviaPrinciples = [
...
export type HojaviaDecision = { educates:boolean; buildsTrust:boolean; strengthensCommunity:boolean; preservesCulture:boolean };
export function constitutionalDecision(input:HojaviaDecision){
