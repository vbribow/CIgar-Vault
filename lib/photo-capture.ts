...
export function photoPreparationError(fileName:string){return `The platform could not prepare ${fileName}. On iPhone, use Open rear camera to take a new photo. For an existing image, share or export it as JPG first.`}
