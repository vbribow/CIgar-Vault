...
export const learningPages = [
  ...
  { path: "/learn/tobacco-seed-varietals", name: "Tobacco Seed and Varietals", description: "Separate cultivars, hybrids, lineage, growing location, leaf role, and producer claims." },
  { path: "/learn/cigar-wrapper-colors", name: "Cigar Wrapper Colors", description: "Separate visible color, wrapper identity, processing, producer labels, and sensory evidence." },
  { path: "/learn/cigar-strength-body-nicotine", name: "Cigar Strength, Body, and Nicotine", description: "Separate flavor intensity, smoke body, producer strength, nicotine exposure, and physical response." },
  { path: "/learn/tasting-vocabulary-calibration", name: "Tasting Vocabulary and Calibration", description: "Record descriptors, intensity, sequence, context, confidence, preference, and quality with a repeatable method." },
