...
export const systemJobs:Array<{id:SystemJobId;name:string;path:string;schedule:string;nextDescription:string}>=[
  ...
  {id:"valuation-monitor",name:"Valuation monitoring",path:"/api/valuation-monitor",schedule:"15 * * * *",nextDescription:"Hourly · new uploads first · supported values refresh monthly · up to 6 due lots"},
