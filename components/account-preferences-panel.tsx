...
const options:[keyof AccountPreferences,string,string][]=[
  ["emailNotifications","Email delivery","Allow Cedriva to send account alerts by email when delivery is configured."],
