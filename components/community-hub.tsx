...
export function CommunityHub({ inventoryOptions = [] }: { inventoryOptions?: CommunityRatingInventoryOption[] }) {
  ...
  return <>
    ...
    {message && <output className="communityMessage">{message}</output>}
