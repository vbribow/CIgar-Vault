...
test("humidor saves a collector-selected climate profile",()=>{const h=HumidorSchema.parse({humidorId:"HUM-1",name:"Cuban cabinet",climateProfile:"habanos",targetTempF:63,minTempF:61,maxTempF:64,targetHumidity:67,minHumidity:65,maxHumidity:70,memberIds:[]});assert.equal(h.climateProfile,"habanos");});
