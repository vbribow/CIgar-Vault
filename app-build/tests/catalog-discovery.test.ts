...
const candidate={brand:"Example Cigars",line:"New Blend",vitola:"Toro",country:"Nicaragua",factory:"Example Factory",brandOwner:"Example Holdings",blender:"Example Blender",wrapper:"Habano",binder:"Nicaragua",filler:"Nicaragua",wrapperOrigin:"Ecuador",binderOrigin:"Nicaragua",fillerOrigins:"Nicaragua",dimensions:"6 × 52",strength:"Medium-full",releaseYear:"2026",edition:"Regular production",packaging:"Box of 20",entityType:"Brand owner" as const,sourceUrl:"https://example.com/new-blend",sourceTitle:"Official release",evidenceDate:"2026-07-21",notes:"New release",confidence:"High" as const};
