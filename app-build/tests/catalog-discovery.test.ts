...
const candidate={brand:"Example Cigars",line:"New Blend",vitola:"Toro",country:"Nicaragua",factory:"Example Factory",brandOwner:"Example Holdings",blender:"Example Blender",entityType:"Brand owner" as const,sourceUrl:"https://example.com/new-blend",sourceTitle:"Official release",evidenceDate:"2026-07-21",notes:"New release",confidence:"High" as const};
