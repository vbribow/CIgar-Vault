...
export function upgradeSuggestion(plan: PlanId, context: UpgradeContext, usage = 0, signals: CollectorSignals = {}) {
  ...
  if (context === "reports" && plan === "free") return { target: "collector" as PlanId, title: "Document the collection to an insurance-ready standard.", detail: "Collector adds a polished insurance schedule while your complete owner-controlled data export remains free.", action: "Review Collector" };
