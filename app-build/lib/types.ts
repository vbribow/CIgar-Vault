...
export type CigarCollection = { collectionId:string; name:string; maker?:string; releaseYear?:string|number; edition?:string; expectedComponents?:number; expectedCigars?:number; presentationInventoryId?:string; wholeMarketValue?:number; acquisitionCost?:number; valuationDate?:string; valuationSource?:string; valuationSourceUrl?:string; status?:"Complete"|"Incomplete"|"Opened"; photoLink?:string; notes?:string };
