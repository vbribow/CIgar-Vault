...
export function SmokingExperienceScorecardView({ lot, identity }: { lot: SmokingExperienceScorecard; identity?: SmokingExperienceScorecard }) {
  ...
  return <section className="section card" aria-labelledby="smoking-scorecard-title">
    ...
    <div className="detailStats">
      <div><span>Overall score</span><RatingLeafMark value={value(summary.overall.average)} label="Your private score" detail={summary.overall.count ? `${summary.overall.count} rated experience${summary.overall.count === 1 ? "" : "s"}` : "Not yet rated"} compact/></div>
