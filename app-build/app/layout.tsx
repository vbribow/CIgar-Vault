...
export async function generateMetadata():Promise<Metadata>{
  ...
  return{
    ...
    icons:brand.key==="hojavia"
      ? {icon:[{url:"/hojavia-mark.svg",type:"image/svg+xml"}]}
      : {icon:[{url:"/cedriva-mark.svg",type:"image/svg+xml"},{url:"/icons/cedriva-app-192-v4.png",sizes:"192x192",type:"image/png"}],apple:[{url:"/icons/cedriva-apple-180-v4.png",sizes:"180x180",type:"image/png"}]},
...
export const viewport:Viewport={width:"device-width",initialScale:1,viewportFit:"cover",themeColor:brand.isPreview?"#173A37":"#0f0d0b"};
