...
export default function TermsPage() {
  return <main className="shell legalPage"><div className="eyebrow">Effective July 24, 2026 · Beta version 1.0</div><h1>{brand.name} Terms of Use</h1><p className="lede">{brand.name} is an educational and collection-stewardship platform. It is not a tobacco seller, medical advisor, insurer, appraiser, or investment advisor.</p>
    ...
    <section><h2>Retail availability and verification scope</h2><p>Retailer identity, price, and stock observations are time-limited commercial information, not completed-sale evidence, authenticity certificates, appraisals, seller endorsements, or promises of availability. Retailers may not influence collection records, evidence classifications, valuations, ratings, or editorial conclusions through payment or participation.</p></section>
