...
const intentions=[
  ...
  ["I want to try something new",`Tell ${brand.name} what kind of experience you want, then explore documented cigars with a clear reason behind every result.`,"#guided-explorer","Guide my exploration"],
