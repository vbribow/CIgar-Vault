...
export const metadata: Metadata = {
  title: `Synthetic Collector Walkthrough · ${brand.name}`,
...
export default function CollectorWalkthroughPage() {
  return <main className="shell walkthroughPage">
    <section className="walkthroughHero">
      <div><div className="eyebrow">Private product walkthrough</div><h1>From acquisition to evidence—without touching your collection.</h1><p className="lede">Follow one synthetic Habanos record through identity, acquisition, package evidence, an official-check state, a careful conclusion, and a portable export.</p></div>
