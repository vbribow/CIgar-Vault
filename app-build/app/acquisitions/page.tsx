...
export default async function AcquisitionsPage() {
  ...
  return <main className="shell acquisitionsPage">
    <nav className="nav"><a className="brand" href="/">{brand.name}</a><div className="navLinks"><a href="/collections">Collections</a><a href="/wishlist">Wishlist</a><span className="badge">Acquisition planner</span></div></nav>
