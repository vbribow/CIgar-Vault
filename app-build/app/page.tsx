...
export default async function Home() {
  ...
  return <main className="shell">
    <section className="hero productHero"><div><div className="eyebrow">{brand.brandLine}</div><h1>{brand.isPreview?"Your collection, with context.":"Your collection is a story worth preserving."}</h1><p className="lede">{brand.spokenName} helps every collector learn with confidence, document with purpose, and remain connected to the people and traditions behind every cigar.</p><div className="ctaRow"><a className="button" href="/inventory">Document my collection</a><a className="button secondary" href="/collector-walkthrough">Try a synthetic walkthrough</a><a className="button secondary" href="/discover">Discover something meaningful</a></div></div><figure className="cultureHero"><img src={"/editorial/cigar-roller-hojavia.png"} alt="A cigar artisan working with tobacco leaves at a rolling table"/><figcaption><span>The craft behind the collection</span><strong>Every cigar begins with people, place, and patience.</strong><a href="https://unsplash.com/photos/vHCkVUogO-w">Original photograph by Austin · Unsplash ↗</a></figcaption></figure></section>
    <CollectorJourney/>
    <DataModelStory/>
