...
export default function ManifestoPage(){return <main className="manifestoPage"><section className="manifestoOpening"><a className="manifestoWordmark" href="/">CEDRIVA</a><div className="eyebrow">The Cedriva Manifesto</div><h1>More than a cigar.<br/><em>A living tradition.</em></h1><p>We are building a home for the knowledge, stories, craftsmanship, and people that make premium cigar culture extraordinary.</p><a className="button" href="#declaration">Read the declaration</a></section><figure className="manifestoVisualIntro"><img src="/og.png" width="1659" height="948" alt="A warm Cedriva workshop with tobacco leaves, a wooden humidor, hand tools, and archival notebooks." fetchPriority="high"/><figcaption><span>Preserve · Honor · Grow</span><p>The culture lives in the hands, knowledge, and stories behind every cigar.</p></figcaption></figure><section className="manifestoDeclaration" id="declaration"><div className="manifestoLead"><span>01</span><h2>We refuse to let a great tradition become disconnected from its story.</h2></div>{declarations.map(([title,body],index)=><article key={title}><span>{String(index+2).padStart(2,"0")}</span><div><h3>{title}</h3><p>{body}</p></div></article>)}</section><section className="manifestoFuture"><div className="eyebrow">What we are here to do</div><h2>Preserve what came before.<br/>Honor those shaping it now.<br/>Grow what comes next.</h2><p>Cedriva will help collectors care for what they own, understand what they experience, remember why it mattered, and share what they learn. We will create tools worthy of exceptional collections—and a welcome worthy of the newest collector.</p></section><section className="manifestoInvitation"><div><div className="eyebrow">This belongs to all of us</div><h2>Bring your knowledge.<br/>Bring your questions.<br/>Bring your story.</h2></div><div><p>If you believe craftsmanship deserves recognition, expertise deserves respect, beginners deserve encouragement, and premium cigar culture deserves a future—there is a place for you here.</p><strong>Help us preserve the tradition.<br/>Help us grow the culture.</strong><div className="ctaRow"><a className="button" href="/login?mode=signup">Join Cedriva</a><a className="button secondary" href="/constitution">Read our Constitution</a></div></div></section><footer className="manifestoFooter"><span>CEDRIVA</span><small>A tradition worth preserving. A culture worth growing.</small></footer></main>}
