...
const Item=z.object({catalogId:z.string().min(1),brand:z.string().min(1),line:z.string().min(1),vitola:z.string().min(1),country:z.string().optional(),factory:z.string().optional(),sourceUrl:z.string().url().optional(),masterNotes:z.string().optional(),researchStatus:z.string().optional()});
