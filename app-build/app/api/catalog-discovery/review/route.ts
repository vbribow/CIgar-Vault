...
const Item=z.object({
  ...
  wrapperOrigin:z.string().optional(),
  binderOrigin:z.string().optional(),
  fillerOrigins:z.string().optional(),
  ...
  sourceType:z.enum(["Official","Verified Historical","Expert","Community","AI-assisted"]).optional(),
