...
export default function HabanosAuthenticityPage() {
  return <main className="shell learnPage">
    ...
    <section className="section card"><div className="eyebrow">Official sources</div><h2>Use the producer’s current tools directly.</h2><p>Habanos identifies counterfeiting as an active concern and directs buyers toward its authorized distribution and retail network. A retailer listing is still a starting point for due diligence—not an endorsement by {brand.name}.</p><div className="ctaRow"><a className="button secondary" href={HABANOS_RETAIL_NETWORK_URL} target="_blank" rel="noreferrer">Authorized network ↗</a><a className="button secondary" href={HABANOS_COUNTERFEIT_GUIDANCE_URL} target="_blank" rel="noreferrer">Counterfeit guidance ↗</a></div></section>
  </main>;
}
