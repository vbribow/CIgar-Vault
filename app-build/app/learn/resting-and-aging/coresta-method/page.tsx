...
export default function CorestaMethodPage() {
  return (
    <main className="shell restingAgingPage sourceGuidePage">
      ...
      <section className="restHero sourceGuideHero"><div><div className="eyebrow">Technical source · explained by Hojavía</div><h1>What the CORESTA conditioning method tells us.</h1><p className="lede">CORESTA Recommended Method No. 46 describes a controlled atmosphere for conditioning cigars before laboratory testing. It is useful evidence about moisture equilibrium—not a universal instruction for storing a personal collection.</p></div></section>
      ...
      <section className="card sourceGuideSource"><div><div className="eyebrow">Original evidence</div><h2>CORESTA Recommended Method No. 46</h2><p>The original document is hosted by CORESTA. Opening it may move you into your phone’s browser or PDF viewer; this Hojavía explanation will remain available for your return.</p></div><a className="button secondary" href={sourceUrl} target="_blank" rel="noopener noreferrer">Open original CORESTA PDF ↗</a></section>
    </main>
  );
}
